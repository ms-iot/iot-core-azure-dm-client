 ...
 */
/* Compiler settings for SystemConfiguratorProxy.Idl:
...
typedef struct _SystemConfiguratorProxy_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } SystemConfiguratorProxy_MIDL_TYPE_FORMAT_STRING;

typedef struct _SystemConfiguratorProxy_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } SystemConfiguratorProxy_MIDL_PROC_FORMAT_STRING;

typedef struct _SystemConfiguratorProxy_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } SystemConfiguratorProxy_MIDL_EXPR_FORMAT_STRING;
...
extern const SystemConfiguratorProxy_MIDL_TYPE_FORMAT_STRING SystemConfiguratorProxy__MIDL_TypeFormatString;
extern const SystemConfiguratorProxy_MIDL_PROC_FORMAT_STRING SystemConfiguratorProxy__MIDL_ProcFormatString;
extern const SystemConfiguratorProxy_MIDL_EXPR_FORMAT_STRING SystemConfiguratorProxy__MIDL_ExprFormatString;

#define GENERIC_BINDING_TABLE_SIZE   0            


/* Standard interface: SystemConfiguratorProxy, ver. 1.0,
   GUID={0x906B0CE0,0xC70B,0x1067,{0xB3,0x17,0x00,0xDD,0x01,0x06,0x62,0xDA}} */


extern const MIDL_SERVER_INFO SystemConfiguratorProxy_ServerInfo;


extern const RPC_DISPATCH_TABLE SystemConfiguratorProxy_v1_0_DispatchTable;

static const RPC_CLIENT_INTERFACE SystemConfiguratorProxy___RpcClientInterface =
    {
    sizeof(RPC_CLIENT_INTERFACE),
    {{0x906B0CE0,0xC70B,0x1067,{0xB3,0x17,0x00,0xDD,0x01,0x06,0x62,0xDA}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&SystemConfiguratorProxy_v1_0_DispatchTable,
    0,
    0,
    0,
    &SystemConfiguratorProxy_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE SystemConfiguratorProxy_v1_0_c_ifspec = (RPC_IF_HANDLE)& SystemConfiguratorProxy___RpcClientInterface;

extern const MIDL_STUB_DESC SystemConfiguratorProxy_StubDesc;

static RPC_BINDING_HANDLE SystemConfiguratorProxy__MIDL_AutoBindHandle;
    ...
    /* [out] */ PPCONTEXT_HANDLE_TYPE pphContext)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SystemConfiguratorProxy_StubDesc,
                  (PFORMAT_STRING) &SystemConfiguratorProxy__MIDL_ProcFormatString.Format[0],
                  hBinding,
                  pphContext);
    ...
    /* [out][in] */ PPCONTEXT_HANDLE_TYPE pphContext)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SystemConfiguratorProxy_StubDesc,
                  (PFORMAT_STRING) &SystemConfiguratorProxy__MIDL_ProcFormatString.Format[36],
                  pphContext);
    ...
    /* [out] */ unsigned long *valuesize)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SystemConfiguratorProxy_StubDesc,
                  (PFORMAT_STRING) &SystemConfiguratorProxy__MIDL_ProcFormatString.Format[74],
                  phContext,
                  knownHKey,
                  subkey,
                  valueName,
    ...
    /* [in] */ unsigned long valuesize)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SystemConfiguratorProxy_StubDesc,
                  (PFORMAT_STRING) &SystemConfiguratorProxy__MIDL_ProcFormatString.Format[160],
                  phContext,
                  hKey,
                  subkey,
                  valuename,
    ...
    /* [optional][in] */ __int64 context)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SystemConfiguratorProxy_StubDesc,
                  (PFORMAT_STRING) &SystemConfiguratorProxy__MIDL_ProcFormatString.Format[240],
                  phContext,
                  samplePeriod,
                  context);
    ...
    /* [in] */ __int64 samplePeriod)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SystemConfiguratorProxy_StubDesc,
                  (PFORMAT_STRING) &SystemConfiguratorProxy__MIDL_ProcFormatString.Format[290],
                  phContext,
                  samplePeriod);
    ...
    /* [in] */ PCONTEXT_HANDLE_TYPE phContext)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SystemConfiguratorProxy_StubDesc,
                  (PFORMAT_STRING) &SystemConfiguratorProxy__MIDL_ProcFormatString.Format[334],
                  phContext);
...
static const SystemConfiguratorProxy_MIDL_PROC_FORMAT_STRING SystemConfiguratorProxy__MIDL_ProcFormatString =
    {
        0,
        {
...
static const SystemConfiguratorProxy_MIDL_TYPE_FORMAT_STRING SystemConfiguratorProxy__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const unsigned short SystemConfiguratorProxy_FormatStringOffsetTable[] =
    {
    0,
    36,
    74,
...
static const unsigned short _callbackSystemConfiguratorProxy_FormatStringOffsetTable[] =
    {
    372
    };


static const MIDL_STUB_DESC SystemConfiguratorProxy_StubDesc = 
    {
    (void *)& SystemConfiguratorProxy___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &SystemConfiguratorProxy__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    SystemConfiguratorProxy__MIDL_TypeFormatString.Format,
...
static const RPC_DISPATCH_FUNCTION SystemConfiguratorProxy_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE SystemConfiguratorProxy_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)SystemConfiguratorProxy_table
    };

static const SERVER_ROUTINE SystemConfiguratorProxy_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)MeteringDataEvent
    };

static const MIDL_SERVER_INFO SystemConfiguratorProxy_ServerInfo = 
    {
    &SystemConfiguratorProxy_StubDesc,
    SystemConfiguratorProxy_ServerRoutineTable,
    SystemConfiguratorProxy__MIDL_ProcFormatString.Format,
    _callbackSystemConfiguratorProxy_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
