...
namespace Microsoft { namespace Devices { namespace Management { namespace Message
{
    ...
    public:
        ...
        static AppUninstallRequest^ Deserialize(Blob^ bytes) {
        ...
        virtual property DMMessageKind Tag {
            DMMessageKind get() { return DMMessageKind::AppUninstall; }
        }
    ...
    public:
        ...
        static AppUninstallResponse^ Deserialize(Blob^ bytes) {
